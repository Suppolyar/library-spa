...
export class Card extends DivComponent {
    ...
    #deleteFromFavorites() {
        this.appState.favorites = this.appState.favorites
            .filter(book => book.key !== this.cardState.key)
    }

    render() {
        this.el.classList.add('card')

        const existInFavorites = this.appState.favorites
            .find(book => book.key === this.cardState.key)
           ...
           <div class="card__image">
            ...
            <div class="card__info">
                ...
                <div class="card__footer">
                    <button class="button__add ${existInFavorites ? 'button__add-active' : ''}">
                        ${existInFavorites
